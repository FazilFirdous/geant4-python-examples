    ...
    $menuData = [
        'Kashmir Wazwan House' => [
            'Wazwan Specials' => [
                ...
                ['Gushtaba', 'Minced mutton balls in creamy yogurt gravy — the grand finale of Wazwan', 350, 0, 1, 30, 'https://images.unsplash.com/photo-1574484284002-952d92456975?w=400'],
                ['Tabak Maaz', 'Crispy fried lamb ribs marinated in Kashmiri spices', 280, 0, 1, 20, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400'],
                ['Yakhni', 'Mutton in aromatic yogurt-saffron curry', 300, 0, 0, 25, 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=400'],
                ['Aab Gosht', 'Milk-based mutton curry with cardamom', 290, 0, 0, 25, 'https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=400'],
            ],
            'Vegetarian' => [
                ...
                ['Haak Saag', 'Kashmiri collard greens in mustard oil', 150, 1, 0, 15, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400'],
                ['Nadru Yakhni', 'Lotus stem in yogurt gravy', 200, 1, 0, 20, 'https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=400'],
            ...
            'Breads & Rice' => [
                ['Kashmiri Naan', 'Traditional tandoori bread', 60, 1, 0, 8, 'https://images.unsplash.com/photo-1600326145308-d3d74efa08be?w=400'],
        ...
        'Royal Bakery & Café' => [
            ...
            'Savory Bakes' => [
                ...
                ['Chicken Roll', 'Stuffed chicken bread roll', 65, 0, 0, 10, 'https://images.unsplash.com/photo-1606491956689-2ea866880049?w=400'],
            ],
            'Sandwiches & Wraps' => [
                ...
                ['Paneer Wrap', 'Spiced paneer in a soft tortilla', 100, 1, 0, 10, 'https://images.unsplash.com/photo-1628191081695-e39c4a0b4ef2?w=400'],
            ],
            'Beverages' => [
        ...
        'Al-Kareem Fast Food' => [
            ...
            'Shawarma & Rolls' => [
                ...
                ['Paneer Shawarma', 'Grilled paneer shawarma wrap', 110, 1, 0, 10, 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=400'],
        ...
        'Chai Shai Corner' => [
            ...
            'Snacks' => [
                ...
                ['Aloo Paratha', 'Stuffed potato paratha with curd', 60, 1, 0, 10, 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400'],
                ['Veg Cutlet', 'Mixed vegetable cutlet with sauce', 40, 1, 0, 8, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
                ['Egg Roll', 'Egg-wrapped roll with onion & chutney', 45, 0, 0, 8, 'https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=400'],
            ],
        ],
        'Mughal Darbar' => [
            'Biryani' => [
                ['Chicken Biryani', 'Fragrant basmati rice layered with spiced chicken', 220, 0, 1, 25, 'https://images.unsplash.com/photo-1631515243349-e0cb75fb8d3a?w=400'],
                ...
                ['Egg Biryani', 'Biryani with boiled eggs & spiced rice', 190, 0, 0, 20, 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400'],
            ],
            'Kebabs' => [
                ['Seekh Kebab', 'Minced mutton kebabs grilled on skewers (4 pcs)', 200, 0, 1, 15, 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400'],
                ...
                ['Paneer Tikka', 'Grilled paneer with bell peppers (8 pcs)', 160, 1, 0, 15, 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400'],
                ['Reshmi Kebab', 'Creamy minced chicken kebabs', 190, 0, 0, 15, 'https://images.unsplash.com/photo-1625937286074-9ca519d5d820?w=400'],
            ],
            'Curries' => [
                ['Butter Chicken', 'Tandoori chicken in rich tomato-butter gravy', 240, 0, 1, 20, 'https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?w=400'],
                ['Mutton Korma', 'Mutton in creamy cashew & onion gravy', 280, 0, 0, 25, 'https://images.unsplash.com/photo-1545247181-516773cae754?w=400'],
                ...
                ['Kadhai Paneer', 'Paneer with bell peppers in spiced gravy', 200, 1, 0, 18, 'https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400'],
            ],
            'Breads' => [
                ['Garlic Naan', 'Butter garlic tandoori naan', 50, 1, 0, 8, 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=400'],
                ['Butter Roti', 'Soft whole wheat bread with butter', 30, 1, 0, 5, 'https://images.unsplash.com/photo-1604152135912-04a022e23696?w=400'],
                ['Laccha Paratha', 'Layered flaky paratha', 45, 1, 0, 8, 'https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=400'],
            ],
        ],
        'Pizza Planet' => [
            'Pizzas' => [
            ...
            'Beverages' => [
                ['Iced Tea', 'Lemon iced tea — 300ml', 60, 1, 0, 3, 'https://images.unsplash.com/photo-1499638673689-79a0b5115d87?w=400'],
                ['Pepsi', 'Chilled Pepsi — 500ml', 40, 1, 0, 2, 'https://images.unsplash.com/photo-1629203851122-3726ecdf080e?w=400'],
            ],
        ],
        'Zaika-e-Kashmir' => [
            'Kashmiri Thali' => [
                ['Veg Thali', 'Rice, dal, 2 sabzi, roti, raita & salad', 150, 1, 1, 20, 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=400'],
                ['Non-Veg Thali', 'Rice, mutton curry, dal, roti, raita & salad', 220, 0, 1, 25, 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400'],
            ],
            'Kashmiri Curries' => [
                ['Rajma Chawal', 'Kashmiri rajma with steamed rice', 120, 1, 1, 15, 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400'],
                ...
                ['Matar Paneer', 'Peas & paneer in tomato gravy', 150, 1, 0, 15, 'https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=400'],
            ],
            'Rice & Breads' => [
                ['Steamed Rice', 'Basmati steamed rice', 60, 1, 0, 8, 'https://images.unsplash.com/photo-1536304929831-ee1ca9d44906?w=400'],
                ['Kashmiri Pulao', 'Sweet saffron rice with dry fruits', 120, 1, 0, 15, 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=400'],
                ['Tandoori Roti', 'Whole wheat tandoori bread', 25, 1, 0, 5, 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400'],
            ],
            'Salads & Sides' => [
                ['Green Salad', 'Fresh cucumber, tomato & onion salad', 40, 1, 0, 5, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400'],
                ['Raita', 'Cool yogurt with mint & cucumber', 30, 1, 0, 3, 'https://images.unsplash.com/photo-1487918678540-64b73e0e7dda?w=400'],
            ],
        ],
        'Frost & Cream' => [
            'Ice Cream Scoops' => [
            ...
            'Sundaes' => [
                ['Chocolate Fudge Sundae', 'Chocolate ice cream, hot fudge, whipped cream', 150, 1, 1, 5, 'https://images.unsplash.com/photo-1488900128323-21503983a07e?w=400'],
                ['Butterscotch Sundae', 'Butterscotch ice cream with caramel & nuts', 140, 1, 0, 5, 'https://images.unsplash.com/photo-1514849302-984523450cf4?w=400'],
                ['Fruit Royale', 'Mixed fruit sundae with vanilla ice cream', 130, 1, 0, 5, 'https://images.unsplash.com/photo-1505394033641-40c6ad1178d7?w=400'],
            ],
            'Shakes' => [
                ['Chocolate Shake', 'Thick chocolate milkshake', 100, 1, 1, 5, 'https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=400'],
                ['Oreo Shake', 'Creamy Oreo cookie milkshake', 110, 1, 0, 5, 'https://images.unsplash.com/photo-1577805947697-89e18249d767?w=400'],
            ...
            'Frozen Treats' => [
                ['Kulfi Stick', 'Traditional malai kulfi on a stick', 50, 1, 0, 2, 'https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=400'],
                ['Ice Cream Sandwich', 'Vanilla ice cream in chocolate cookies', 70, 1, 0, 3, 'https://images.unsplash.com/photo-1580915411954-282cb1b0d780?w=400'],
                ['Popsicle', 'Fruit popsicle — mango or orange', 30, 1, 0, 2, 'https://images.unsplash.com/photo-1560008581-09826d1de69e?w=400'],
            ],
        ],
    ];
